...
We are using CVXPY as an interface to LP / MIP solvers. See `CVXPY on GitHub <https://github.com/cvxpy/cvxpy>`_. You can find details on supported solvers here: `CVXPY solvers <https://www.cvxpy.org/tutorial/solvers>`_. The list includes open sources solvers such as HighS and SCIP as well as commercial solvers such as Gurobi or CLPEX.
