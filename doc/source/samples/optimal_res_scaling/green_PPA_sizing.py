...
from eaopack.serialization import from_json, run_from_json
...
###############################################   import
timegrid = from_json(file_name=file_timegrid)
prices = from_json(file_name=file_prices)


# ###############################################   optimization and writing
print("Volume matched: optimize and write results")
run_from_json(
    file_name_in=file_vol_matching_assets,
    prices=prices,
    timegrid=timegrid,
...
run_from_json(
    file_name_in=file_scaling_assets,
    prices=prices,
    timegrid=timegrid,
